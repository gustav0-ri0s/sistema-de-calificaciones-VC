...
import { ShieldCheck, Users, FileText, CheckCircle2, Search, LayoutGrid, ChevronRight, ArrowLeft, Info, X, Lock, Loader2, MessageSquare, Briefcase, GraduationCap, Download, RotateCw, Check, AlertCircle } from 'lucide-react';
